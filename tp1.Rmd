...
abline(a=m1$coef[1] + m1$coef[3], b=m1$coef[2], col=2)
abline(a=m1$coef[1] + m1$coef[4], b=m1$coef[2], col=3)
abline(a=m1$coef[1] + m1$coef[5], b=m1$coef[2], col=4)
abline(a=m1$coef[1] + m1$coef[6], b=m1$coef[2], col=5)
